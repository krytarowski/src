 ...
 * created from	NetBSD: syscalls.master,v 1.125 2019/01/27 02:08:40 pgoyette Exp
 */
...
struct netbsd32_pinspect_args {
	syscallarg(int) req;
	syscallarg(netbsd32_voidp) addr;
	syscallarg(int) data;
};
check_syscall_args(netbsd32_pinspect)
...
int	netbsd32_pinspect(struct lwp *, const struct netbsd32_pinspect_args *, register_t *);
